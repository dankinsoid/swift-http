...
//
//    associatedtype In: HttpPipeline = HttpRawPipeline
//    associatedtype Out: HttpPipeline = In
...
//        pipeline: some HttpPipeline<Data?, HttpResponse>
//    ) -> some HttpPipeline {
//        pipeline
...
//    associatedtype InitialPipeline: HttpPipeline<Request, Response> = HttpEmptyPipeline
//
//    var initialPipeline: InitialPipeline { get }
//
//    func pipeline(
//        _ pipeline: some HttpPipeline
//    ) -> PipelineChained
//}
//
...
//
//    func pipeline(
//        _ pipeline: (any HttpPipeline<HttpRequest, HttpResponse>) -> some HttpPipeline<HttpRequest, HttpResponse>
//    ) -> HttpClient {
