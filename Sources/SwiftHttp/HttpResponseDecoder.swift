...
//public struct HttpResponseDecoder<T: Decodable>: HttpPipeline {
//
//    /// The response valdators
//    public let validator: any HttpResponseValidator
//
...
//}
//
//public extension HttpValidator where Self == HttpHeaderValidator {
//
//    static var contentJson: HttpHeaderValidator {
